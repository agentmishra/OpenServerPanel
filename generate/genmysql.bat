...
if not "%1"=="MySQL-5.7" if not "%1"=="MySQL-8.0" call perl scripts\mysql_install_db.pl --basedir="%OSP_ROOT_DIR%modules\%1" --datadir="%OSP_ROOT_DIR%data\%1\default" --skip-name-resolve --windows --verbose
